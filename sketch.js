...
function preload(){
    ...
    homeesImg = loadImage("homees.png");
...
function draw() {
    ...
    if (mousePressedOver(muscle)) {
        ...
        home = createSprite(950, 550);
        home.addImage(homeImg);
        home.scale = 0.1;

      }

      if(mousePressedOver(slim)){
        ...
        homees = createSprite(940, 550);
        homees.addImage(homeesImg);
        homees.scale = 0.2;
